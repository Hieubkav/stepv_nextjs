...
const VisionAbout: React.FC<VisionAboutProps> = ({
  badge,
  titleLine1,
  titleLine2,
  description,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center">
          ...
          >
            ...
            <h2 style={{ fontFamily: "'Noto Sans', 'Inter', sans-serif" }} className="text-xl sm:text-2xl md:text-5xl text-white leading-tight mb-4 md:mb-8 font-bold">
              ...
              <span className="text-[#D4AF37] italic block sm:inline">{titleLine2 || 'Tiêu Chuẩn Duy Nhất'}</span>
            </h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-4 md:gap-8">
              {displayFeatures.map((feature, index) => (
                <div key={index} className="bg-[#0A0A0A] p-4 md:p-6 border border-white/5 hover:border-[#D4AF37]/20 transition-colors">
                  <h4 style={{ fontFamily: "'Noto Sans', 'Inter', sans-serif" }} className="text-white text-sm md:text-lg mb-2 font-bold">{feature.title}</h4>
          ...
          >
            ...
            <div className="w-full h-full bg-[#111] border border-[#D4AF37]/20 relative group overflow-hidden">
              ...
              <img 
                src={image || "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?q=80&w=1974&auto=format&fit=crop"} 
                alt={imageAlt || "Abstract Texture"} 
              ...
              <div className="absolute bottom-3 md:bottom-6 left-3 md:left-6 z-20">
                <p className="text-[#D4AF37] text-[10px] md:text-xs font-serif italic tracking-wider">{yearEstablished || 'Est. 2019'}</p>
                <p className="text-white text-[9px] md:text-xs uppercase tracking-widest mt-1 font-bold">{tagline || 'Premium Standard'}</p>
              </div>
